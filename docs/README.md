...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-19 21:21:17 UTC<br>状态：成功</p>
</section>
...
<p>精读：《PiPS: Post-Hoc Prototypical Explanations for Interpretable Semantic Segmentation》（8.0/10）, 《SenseFuse: Label-Free Fusion of Image and Shape Encoders for Open-Vocabulary 3D Instance Segmentation》（8.0/10）</p>
<p>速读：《NeuSOGA3D: A Neuro-Symbolic Framework for Explainable 3D Geometric Reconstruction》（7.0/10）, 《Pre-Trained Low-Rank Tensor Decomposition for Multi-Dimensional Image Recovery》（6.0/10）, 《PhysVGGT: Feed-Forward Dense Physical Property Estimation from A Single Image》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="PiPS: Post-Hoc Prototypical Explanations for Interpretable Semantic Segmentation">PiPS: Post-Hoc Prototypical Explanations for Interpretable Semantic Segmentation</span></li><li><span class="dpr-home-dashboard-paper-title" title="SenseFuse: Label-Free Fusion of Image and Shape Encoders for Open-Vocabulary 3D Instance Segmentation">SenseFuse: Label-Free Fusion of Image and Shape Encoders for Open-Vocabulary 3D Instance Segmentation</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="NeuSOGA3D: A Neuro-Symbolic Framework for Explainable 3D Geometric Reconstruction">NeuSOGA3D: A Neuro-Symbolic Framework for Explainable 3D Geometric Reconstruction</span></li><li><span class="dpr-home-dashboard-paper-title" title="Pre-Trained Low-Rank Tensor Decomposition for Multi-Dimensional Image Recovery">Pre-Trained Low-Rank Tensor Decomposition for Multi-Dimensional Image Recovery</span></li><li><span class="dpr-home-dashboard-paper-title" title="PhysVGGT: Feed-Forward Dense Physical Property Estimation from A Single Image">PhysVGGT: Feed-Forward Dense Physical Property Estimation from A Single Image</span></li></ul>
  </div>
